...
var ControllerChangeEvent = /*#__PURE__*/_createClass(function ControllerChangeEvent(fields) {
  ...
  this.fields = fields; // delta time defaults to 0.
...
var ControllerOnEvent = /*#__PURE__*/function () {
  function ControllerOnEvent(fields) {
    _classCallCheck(this, ControllerOnEvent);
  ...
  _createClass(ControllerOnEvent, [{
    key: "buildData",
    value: function buildData(track, precisionDelta) {
      this.data = []; // Explicitly defined startTick event
...
var ControllerOffEvent = /*#__PURE__*/function () {
  function ControllerOffEvent(fields) {
    _classCallCheck(this, ControllerOffEvent);
  ...
  _createClass(ControllerOffEvent, [{
    key: "buildData",
    value: function buildData(track, precisionDelta) {
      if (this.tick === null) {
        this.tick = Utils.getRoundedIfClose(this.delta + track.tickPointer);
...
var ControllerEvent = /*#__PURE__*/function () {
  function ControllerEvent(fields) {
    _classCallCheck(this, ControllerEvent);
  ...
  _createClass(Track, [{
    ...
    value: function buildData() {
      ...
      this.events.forEach(function (event, eventIndex) {
        ...
        if (event instanceof NoteOnEvent || event instanceof NoteOffEvent || event instanceof ControllerOnEvent || event instanceof ControllerOffEvent) {
...
var main = {
  ...
  ControllerOnEvent: ControllerOnEvent,
  ControllerOffEvent: ControllerOffEvent,
